...
def example_1_basic_parallel():
    ...
    results = process_images_parallel(image_paths, process_image, num_workers=4, use_gpu=False, progress=True)
...
def example_4_real_images():
    ...
    # Process in parallel
    results = process_images_parallel(image_paths, process_image, num_workers=4, progress=True)
