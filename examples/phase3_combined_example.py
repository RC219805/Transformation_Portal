...
def example_3_with_caching():
    ...
    # Initialize cache
    cache_config = CacheConfig(cache_dir=Path(".cache/phase3_example"), max_size_gb=1.0)
    ...
    def process_image_cached(image_path):
        ...
        depth = cache.get_or_compute("depth_maps", lambda: compute_depth(image), inputs={"image": image_path})
