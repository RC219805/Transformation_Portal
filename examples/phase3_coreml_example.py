...
def example_1_export_model():
    ...
    coreml_path = exporter.export_depth_model(model_name="depth_anything_v2_small", optimize_for_ane=True)
...
def example_3_depth_estimation():
    ...
    try:
        estimator = CoreMLDepthEstimator(model_name="depth_anything_v2_small", prefer_coreml=True)
