...
def demo_normal_map_generation(depth_uint16: np.ndarray, output_dir: Path):
    ...
    from lux_depth_v2.normal_map import NormalMapGenerator, PRESETS, generate_normal_map
...
def demo_quality_analysis(rgb: np.ndarray, depth: np.ndarray, depth_uint16: np.ndarray, output_dir: Path):
    ...
    from lux_depth_v2.quality_metrics import DepthQualityAnalyzer, quick_quality_check
    ...
    analyzer = DepthQualityAnalyzer(target_edge_alignment=0.6, target_edge_width_px=3.0, target_unique_levels=10000)
