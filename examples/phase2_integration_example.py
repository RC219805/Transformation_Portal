...
def process_luxury_image_phase2(
    ...
    for material_type, confidence in sorted(material_result.materials.items(), key=lambda x: x[1].percentage, reverse=True)[
        :3
    ]:
        print(
    ...
    detector.generate_report(material_result, output_dir / f"{image_path.stem}_materials.json")
