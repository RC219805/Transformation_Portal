...
def example_social_media_workflow():
    ...
    config = UnifiedPipelineConfig(
        ...
        output_formats=[OutputFormat.SOCIAL, OutputFormat.WEB_4K],  # 1080p for Instagram  # 4K for website
...
def example_print_production():
    ...
    config = UnifiedPipelineConfig(
        ...
        output_formats=[OutputFormat.MASTER_TIFF, OutputFormat.PRINT_8K],  # 16-bit master archive  # 8K print JPEG
