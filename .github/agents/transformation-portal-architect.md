...
- No pipeline may import another pipeline’s internal modules unless explicitly approved and documented.
...
Escalation criteria and the stop-and-escalate protocol are defined in:
- `docs/architecture/agent_governance.md`

When escalated, you must provide an explicit decision or direction (and require ADR/enforcement updates when warranted).
...
- verifying alignment with architecture and policy
- ensuring enforcement exists (tests + CI gates + documentation fidelity)
