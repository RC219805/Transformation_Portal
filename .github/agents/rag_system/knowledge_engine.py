    ...
    def query_natural_language(self, query: str) -> str:
        ...
        if "success rate" in query_lower or "success" in query_lower:
            ...
            if mentioned_pipeline:
                ...
                return f"The success rate for {mentioned_pipeline} is {rate} over the last 30 days ({runs} runs)."
            else:
        ...
        if "performance" in query_lower or "speed" in query_lower or "time" in query_lower:
            ...
            if mentioned_pipeline:
                ...
                return (
                    f"Performance for {mentioned_pipeline}: Average {avg}, "
        ...
        return (
            "I understand queries about success rates, performance, errors, "
