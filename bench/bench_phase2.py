...
class PerformanceBenchmark:
    ...
    def generate_markdown_report(self, summary: BenchmarkSummary) -> str:
        ...
        for preset, stats in preset_stats.items():
            ...
            lines.append(f"| {preset} | {avg_clip:.3f} | {avg_preset:.3f} | {total_overhead:.3f} |")
        ...
        for tier in ["STANDARD", "MAX", "APEX"]:
            ...
            lines.append(f"| {tier} | {avg_init:.2f} | {avg_model:.2f} | {avg_mem:.0f} | {backend} |")
...
def main():
    ...
    available_images = [img for img in test_images if (repo_root / img).exists()]
