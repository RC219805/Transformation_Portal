...
function renderLanternMark(title) {
  const safeTitle = escapeHtml(title || "Dynamic Neural Access brand mark");
  return `<svg class="brand-mark" viewBox="0 0 256 256" role="img" aria-labelledby="brandMarkTitle" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <title id="brandMarkTitle">${safeTitle}</title>
    <defs>
      <linearGradient id="brandGradient" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stop-color="var(--brand-azure)" />
...
export { escapeHtml, renderLanternMark };
