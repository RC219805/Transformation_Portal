...
- **Workflow guide:** docs/quick_references/PROCESSING_QUICK_REFERENCE.md
...
1. **docs/quick_references/PROCESSING_QUICK_REFERENCE.md** (10 min) - How to process images
...
docs/quick_references/PROCESSING_QUICK_REFERENCE.md          ← Workflow guide ⭐
...
- **docs/quick_references/PROCESSING_QUICK_REFERENCE.md** - Practical workflow guide
...
3. Refer to docs/quick_references/PROCESSING_QUICK_REFERENCE.md for workflows
...
| **How to process** | docs/quick_references/PROCESSING_QUICK_REFERENCE.md | 10 min |
