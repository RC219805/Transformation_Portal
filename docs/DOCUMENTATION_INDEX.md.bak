...
2. **PROCESSING_QUICK_REFERENCE.md** 🔧 **PRACTICAL GUIDE**
   - Workflow templates
...
### Quick References
- **PROCESSING_QUICK_REFERENCE.md** ⭐ - Universal workflow guide
...
- PROCESSING_QUICK_REFERENCE.md (workflow)
...
3. Review: **PROCESSING_QUICK_REFERENCE.md**
...
3. **Zone-Based Processing** (All images)
   ...
   - **Document:** PROCESSING_QUICK_REFERENCE.md
...
**Refer to:** PROCESSING_QUICK_REFERENCE.md  
