...
> Historical note: this is a point-in-time implementation summary from the
> `claude/ad-editorial-pipeline-011CUPvKF5YTpysvQS926ZBK` branch. Deprecated
> v2/v3 code and tests now live under `tools/deprecated/`; the maintained
> operator entrypoint is `tools/ad_editorial_post_pipeline.py`.
...
6. **AD_EDITORIAL_POST_PIPELINE_FIXES_APPLIED.md**
   - Priority 1 fixes (critical bugs)
   - Before/after code examples
   - Testing checklist
   - Known limitations

7. **AD_EDITORIAL_POST_PIPELINE_V2_ENHANCEMENTS.md**
   - Priority 2+ improvements
   - Performance benchmarks
   - Migration guide
   - Best practices

8. **AD_EDITORIAL_POST_PIPELINE_IMPLEMENTATION_SUMMARY.md** (this file)
...
python tools/deprecated/ad_editorial_post_pipeline_v2.py run --config my_project.yml -vv

# 4. Resume if interrupted
python tools/deprecated/ad_editorial_post_pipeline_v2.py run --config my_project.yml --resume
```
...
├── tools/
│   ├── ad_editorial_post_pipeline.py      # Current maintained entrypoint
│   ├── deprecated/
│   │   ├── ad_editorial_post_pipeline_v2.py
│   │   ├── ad_editorial_post_pipeline_v3.py
│   │   ├── test_ad_pipeline.py
│   │   └── test_ad_pipeline_v3.py
│   ├── sample_config.yml                  # Configuration template
│   └── README.md                          # Current usage documentation
└── docs/historical/script-audits/
    ├── AD_EDITORIAL_POST_PIPELINE_FIXES_APPLIED.md
    ├── AD_EDITORIAL_POST_PIPELINE_V2_ENHANCEMENTS.md
    └── AD_EDITORIAL_POST_PIPELINE_IMPLEMENTATION_SUMMARY.md
...
python tools/deprecated/ad_editorial_post_pipeline_v3.py run \
...
python tools/deprecated/ad_editorial_post_pipeline_v2.py run \
    --config ~/Photography/ClientName_config.yml \
    --resume
```
...
pytest tools/deprecated/test_ad_pipeline.py -vv --tb=long
```

### Getting Help

1. **Check documentation:**
   - `docs/guides/AD_EDITORIAL_POST_PIPELINE.md` - Current usage
   - `AD_EDITORIAL_POST_PIPELINE_V2_ENHANCEMENTS.md` - Historical v2 features
   - `AD_EDITORIAL_POST_PIPELINE_FIXES_APPLIED.md` - Historical bug fixes
