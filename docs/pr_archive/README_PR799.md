...
- **[ADMIN_BRANCH_PROTECTION_UPDATE.md](../ci/ADMIN_BRANCH_PROTECTION_UPDATE.md)** - Quick reference card with step-by-step instructions to update GitHub branch protection settings
...
2. ⚠️ **Admin**: Update branch protection settings per [ADMIN_BRANCH_PROTECTION_UPDATE.md](../ci/ADMIN_BRANCH_PROTECTION_UPDATE.md)
...
**Quick Start**: If you're an admin, go directly to [ADMIN_BRANCH_PROTECTION_UPDATE.md](../ci/ADMIN_BRANCH_PROTECTION_UPDATE.md)
