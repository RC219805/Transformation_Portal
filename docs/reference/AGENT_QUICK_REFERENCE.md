...
Current baseline: the source-reviewed refresh linked in the documentation map. Use the documentation map
and linked source-reviewed refresh for current navigation; prior state audits
remain historical evidence; historical
...
- **Documentation Refresh Audit**: [DOCUMENTATION_REFRESH_AUDIT_2026-09-12.md](../governance/DOCUMENTATION_REFRESH_AUDIT_2026-09-12.md)
