...
class PresetSelector:
    ...
    def __init__(
        ...
        if not CLIP_AVAILABLE:
            raise ImportError("CLIP classifier not available. Install with: pip install transformers torch")
    ...
    def select_preset(
        ...
        return PresetRecommendation(preset=preset, scene=scene, fallback_used=fallback_used, reason=reason)
    ...
    def select_preset_from_path(self, image_path: Union[str, Path], quality_tier: QualityTier = QualityTier.MAX) -> Preset:
        """
