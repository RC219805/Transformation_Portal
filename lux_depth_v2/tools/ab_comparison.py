...
def save_comparison_visualization(rgb: np.ndarray, baseline_depth: np.ndarray, enhanced_depth: np.ndarray, output_path: Path):
    ...
    # Stack horizontally
    comparison = np.hstack([cv2.cvtColor(rgb_small, cv2.COLOR_RGB2BGR), baseline_color, enhanced_color])
...
def run_ab_comparison(
    ...
    save_comparison_visualization(rgb, baseline_depth, enhanced_depth, output_dir / "comparison.png")
