...
def test_tiled_upscaler_basic():
    ...
    cfg = SimpleNamespace(upscale=2, upscale_tile_size=256, upscale_tile_overlap=32)
...
def test_tiled_vs_full_consistency():
    ...
    # Tiled upscaling
    cfg_tiled = SimpleNamespace(upscale=2, upscale_tile_size=256, upscale_tile_overlap=32)
...
def test_tiled_upscaling_memory_efficiency():
    ...
    cfg_tiled = SimpleNamespace(upscale=2, upscale_tile_size=1024, upscale_tile_overlap=64)
    upscaler_tiled = TorchUpscaler(cfg_tiled, device)
    output_tiled = upscaler_tiled.upscale(input_tensor)
...
def test_phase2_config_integration():
    ...
    cfg_legacy = SimpleNamespace(upscale=2, upscale_tile_size=1024, upscale_tile_overlap=64)
