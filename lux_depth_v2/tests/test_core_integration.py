...
class TestCoreConfigIntegration:
    ...
    def test_device_config_generation(self):
        ...
        cfg = PipelineConfig(device="cuda", precision="fp16", cudnn_benchmark=True, warn_float_gb=6.0)
    ...
    def test_paths_config_generation(self):
        ...
        cfg = PipelineConfig(input_dir=Path("/tmp/input"), output_dir=Path("/tmp/output"))
