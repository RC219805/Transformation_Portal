...
class TestServiceModeSecurity:
    ...
    def test_validate_filepath_rejects_path_traversal(self):
        ...
        assert '"/"' in service_src or '"\\\\' in service_src, "validate_filepath missing slash checks"
    ...
    def test_validate_filepath_has_null_byte_checks(self):
        ...
        assert "'\\x00'" in func_body or '"\\x00"' in func_body or "'\\0'" in func_body or '"\\0"' in func_body, (
    ...
    def test_validate_filepath_has_extension_validation(self):
        ...
        assert ".tif" in service_src or "tiff" in service_src.lower(), "validate_filepath missing TIFF extension support"
...
class TestModelSecurity:
    ...
    def test_segmentation_config_has_revision_field(self):
        ...
        assert hasattr(cfg, "segformer_revision"), "SegmentationConfig missing segformer_revision field"
