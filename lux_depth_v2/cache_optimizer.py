...
class DepthMapCache:
    ...
    def get(self, image_path: Path, validate: bool = True) -> Optional[np.ndarray]:
        """
    ...
    def set(self, image_path: Path, depth_map: np.ndarray):
        """
        Cache depth map.
    ...
    def get_or_generate(self, image_path: Path, generator_fn: callable, force_regenerate: bool = False) -> np.ndarray:
        """
