...
class TaskCheckpoint:
    ...
    def can_resume(self) -> bool:
        ...
        return not self.success and self.retry_count < self.max_retries and self.current_stage != ProcessingStage.COMPLETE
...
class CheckpointManager:
    ...
    def save_checkpoint(
        ...
        try:
            ...
            self.logger.debug(f"Checkpoint saved | task_id={task_id} stage={stage.value} status={status}")
    ...
    def load_checkpoint(self, task_id: str) -> Optional[TaskCheckpoint]:
        ...
        try:
            ...
            self.logger.debug(
                f"Checkpoint loaded | task_id={task_id} stage={checkpoint.current_stage.value} success={checkpoint.success}"
            )
