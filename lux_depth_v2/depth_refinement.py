...
class ProductionDepthRefiner:
    ...
    def _apply_guided_filter(self, depth: np.ndarray, guide: Optional[np.ndarray] = None) -> np.ndarray:
        """
    ...
    def _apply_edge_snap(self, depth: np.ndarray, rgb: Optional[np.ndarray] = None) -> np.ndarray:
        """
    ...
    def refine(self, depth: np.ndarray, rgb: Optional[np.ndarray] = None) -> np.ndarray:
        """
