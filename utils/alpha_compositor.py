...
class AlphaCompositor:
    ...
    def _flatten_to_color(self, rgb: np.ndarray, alpha: np.ndarray, bg_color: Tuple[float, float, float]) -> np.ndarray:
    ...
    def _composite_branded(self, rgb: np.ndarray, alpha: np.ndarray, brand_image: np.ndarray) -> np.ndarray:
    ...
    def generate_variants(self, image: np.ndarray, modes: Optional[list] = None) -> dict:
        """
