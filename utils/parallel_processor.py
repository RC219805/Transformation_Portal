...
class ParallelProcessor:
    ...
    def process_batch(
        ...
        self.stats.throughput_per_hour = (
            self.stats.completed_tasks / self.stats.total_time_seconds * 3600 if self.stats.total_time_seconds > 0 else 0
        )
    ...
    @staticmethod
    def _safe_process(process_fn: Callable, item: Any, gpu_id: Optional[int] = None) -> Tuple[Any, Optional[Exception]]:
