...
def test_blend_weights():
    ...
    h_overlap = weight_accum[config.tile_size // 2 : config.tile_size // 2 + 10, stride : stride + 10]
    ...
    if 0.95 <= center_mean <= 1.05 and 0.95 <= h_overlap_mean <= 1.05 and 0.95 <= junction_mean <= 1.05:
