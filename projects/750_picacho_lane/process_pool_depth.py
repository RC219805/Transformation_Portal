...
def main():
    ...
    input_image = Path("/Users/rc/Transformation_Portal/input_images/V2_V2_750Picacho_Pool_Luxury_Enhanced.tiff")
    output_dir = Path("/Users/rc/Transformation_Portal/output_images/depth_processed")
