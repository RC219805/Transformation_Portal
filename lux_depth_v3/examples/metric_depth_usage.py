...
def example_1_architectural_measurements():
    ...
    result = convert_to_metric_depth(depth=depth_output, model_name="DA3METRIC-LARGE", intrinsics=intrinsics)
...
def example_3_material_estimation():
    ...
    result = convert_to_metric_depth(depth=depth_output, model_name="DA3METRIC-LARGE", focal_length_px=focal_px)
...
def example_4_model_comparison():
    ...
    print("\n1️⃣  DA3METRIC-LARGE:")
    metric_result = convert_to_metric_depth(depth=depth_output, model_name="DA3METRIC-LARGE", focal_length_px=focal_px)
    ...
    nested_result = convert_to_metric_depth(depth=depth_output, model_name="DA3NESTED-GIANT-LARGE-1.1")
...
def example_5_depth_zones():
    ...
    result = convert_to_metric_depth(depth=depth_output, model_name="DA3METRIC-LARGE", focal_length_px=600.0)
...
def example_6_save_load():
    ...
    result = convert_to_metric_depth(depth=depth_output, model_name="DA3METRIC-LARGE", focal_length_px=550.0)
...
def example_7_quick_conversion():
    ...
    depth_meters = depth_to_meters(depth=depth_output, focal_length_px=500.0)
