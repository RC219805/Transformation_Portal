...
def test_compute_trimap_iou():
    ...
    iou_core, iou_boundary, iou_bg = compute_trimap_iou(pred_mask, ref_mask, band_width_px=3)
...
def test_boundary_metrics_with_gradients():
    ...
    metrics = compute_full_boundary_metrics(pred_mask, ref_mask, image_gradients=gradients, band_width_px=3)
