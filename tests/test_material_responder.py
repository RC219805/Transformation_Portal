...
class TestMaterialResponder:
    ...
    def test_enhance_surface(self, responder, sample_image):
        ...
        enhanced = responder.enhance_surface(sample_image, SurfaceType.WOOD, confidence_map, depth_map=None)
    ...
    def test_enhance_with_depth(self, responder, sample_image):
        ...
        enhanced = responder.enhance(sample_image, surfaces=["wood"], depth_map=depth_map)
    ...
    def test_enhance_multiple_surfaces(self, responder, sample_image):
        ...
        enhanced = responder.enhance(sample_image, surfaces=["wood", "metal", "glass"])
    ...
    def test_enhance_unknown_surface(self, responder, sample_image):
        ...
        enhanced = responder.enhance(sample_image, surfaces=["unknown_material"])
...
class TestMaterialResponderConvenience:
    ...
    def test_create_material_responder(self):
        ...
        responder = create_material_responder(strength=0.8, surfaces=["wood", "metal"], depth_aware=True)
