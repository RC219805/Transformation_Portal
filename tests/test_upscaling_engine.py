...
@pytest.mark.skipif(not UPSCALING_AVAILABLE or not TORCH_AVAILABLE, reason="PyTorch required")
...
@pytest.mark.skipif(not UPSCALING_AVAILABLE or not TORCH_AVAILABLE, reason="Full stack required")
