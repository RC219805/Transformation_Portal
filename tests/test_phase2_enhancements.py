...
class TestDepthAwareLUT:
    ...
    def test_zone_mask_creation(self, sample_depth_map):
        ...
        config = DepthAwareLUTConfig(zone_configs={}, depth_falloff=2.0)
    ...
    def test_depth_aware_lut_application(self, sample_lut_file, sample_depth_map):
        ...
        config = DepthAwareLUTConfig(
            zone_configs={
                DepthZone.FOREGROUND: ZoneLUTConfig(zone=DepthZone.FOREGROUND, lut_path=sample_lut_file, strength=0.8),
                DepthZone.BACKGROUND: ZoneLUTConfig(zone=DepthZone.BACKGROUND, lut_path=sample_lut_file, strength=0.5),
            },
