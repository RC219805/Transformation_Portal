...
class TestConvenienceFunction:
    ...
    def test_process_images_parallel(self):
        ...
        results = process_images_parallel(image_paths, _image_process_fn, num_workers=2, use_gpu=False, progress=False)
...
class TestGPULoadBalancing:
    ...
    def test_gpu_id_assignment(self):
        ...
        config = WorkerConfig(mode=ProcessingMode.MULTI_GPU, gpu_ids=[0, 1, 2], num_workers=6)
        processor = ParallelProcessor(config)
