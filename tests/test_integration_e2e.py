...
class TestFeatureIntegration:
    ...
    def test_metric_depth_conversion(self, test_intrinsics):
        ...
        result = convert_to_metric_depth(depth, model_name="DA3METRIC-LARGE", intrinsics=test_intrinsics)
        ...
        result_nested = convert_to_metric_depth(depth, model_name="DA3NESTED-GIANT-LARGE-1.1")
...
class TestEndToEndWorkflow:
    ...
    def test_single_image_inference(self, test_images_dir, tmp_path):
        ...
        result = engine.infer(images=[image_path], export_dir=tmp_path / "output")
    ...
    def test_multi_view_inference(self, test_images_dir, tmp_path):
        ...
        result = engine.infer(images=images, export_dir=tmp_path / "output")
