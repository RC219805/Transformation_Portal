...
class TestResourceMonitor:
    ...
    def test_monitor_initialization(self):
        ...
        thresholds = ResourceThresholds(mps_memory_gb=50.0, cpu_percent=80.0, ram_percent=75.0, disk_space_gb=20.0)
...
class TestCheckpointManager:
    ...
    def test_can_resume(self, tmp_path):
        ...
        manager.save_checkpoint(task_id="test_001", stage=ProcessingStage.DEPTH_LOAD, status="success")
...
class TestErrorRecovery:
    ...
    def test_execute_with_retry_success(self):
        ...
        result, success, error = recovery.execute_with_retry(success_func, "task_001")
    ...
    def test_execute_with_retry_failure(self):
        ...
        result, success, error = recovery.execute_with_retry(fail_func, "task_001")
...
class TestPreFlightValidator:
    ...
    def test_validate_all(self, tmp_path):
        ...
        report = validator.validate_all(input_path=input_file, depth_dir=None, device="cpu", upscale=2)
