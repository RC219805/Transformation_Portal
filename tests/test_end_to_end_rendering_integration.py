...
class TestFullPipelineIntegration:
    ...
    def test_complete_pipeline_all_stages_enabled(self, pipeline_with_mocks, test_images, mock_context_module):
    ...
    def test_pipeline_preserves_processing_chain_order(self, pipeline_with_mocks, test_images, mock_context_module):
        ...
        with patch.dict(sys.modules, {"architectural_context_extractor": mock_context_module}):
            with patch.object(pipeline_with_mocks, "_apply_depth_processing", side_effect=track_depth):
                with patch.object(pipeline_with_mocks, "_apply_color_grading", side_effect=track_color):
    ...
    def test_pipeline_handles_partial_processing(self, pipeline_with_mocks, test_images, mock_context_module):
    ...
    def test_pipeline_graceful_degradation_missing_depth(self, pipeline_with_mocks, test_images, mock_context_module):
...
class TestStrategyToConfigIntegration:
    ...
    def test_kitchen_strategy_produces_correct_depth_config(self, pipeline_with_mocks, test_images, mock_context_module):
    ...
    def test_bedroom_strategy_produces_warm_color_config(self, mock_context_module, tmp_path):
    ...
    def test_outdoor_strategy_produces_atmospheric_depth(self, pipeline_with_mocks, test_images, mock_context_module):
    ...
    def test_material_config_reflects_room_materials(self, mock_context_module, tmp_path):
...
class TestMultiRoomProcessing:
    ...
    def test_process_multiple_rooms_maintains_context(self, pipeline_with_mocks, test_images, mock_context_module):
    ...
    def test_unknown_room_uses_default_strategy(self, pipeline_with_mocks, test_images, mock_context_module):
...
class TestConfigFileIntegration:
    ...
    def test_strategy_json_contains_all_fields(self, pipeline_with_mocks, test_images, mock_context_module):
    ...
    def test_depth_config_json_structure(self, pipeline_with_mocks, test_images, mock_context_module):
...
class TestDesignStyleIntegration:
    ...
    def test_modern_style_affects_color_temperature(self, mock_context_module, tmp_path):
    ...
    def test_traditional_style_affects_enhancement(self, mock_context_module, tmp_path):
...
class TestDepthPipelineConfigBuilding:
    ...
    def test_build_depth_pipeline_config_complete(self, pipeline_with_mocks, mock_context_module):
    ...
    def test_atmospheric_depth_enables_atmospheric_effects(self, pipeline_with_mocks, mock_context_module):
    ...
    def test_foreground_depth_disables_atmospheric_effects(self, pipeline_with_mocks, mock_context_module):
...
class TestOutputQualityVerification:
    ...
    def test_output_preserves_input_format(self, pipeline_with_mocks, tmp_path, mock_context_module):
    ...
    def test_output_image_dimensions_preserved(self, pipeline_with_mocks, tmp_path, mock_context_module):
        """Verify output dimensions match input."""
        img_path = tmp_path / "test_living.jpg"
        original_size = (400, 300)
        Image.fromarray(np.full((300, 400, 3), 128, dtype=np.uint8)).save(img_path, quality=95)
    ...
    def test_output_image_valid_pixel_range(self, pipeline_with_mocks, test_images, mock_context_module):
...
class TestErrorHandling:
    ...
    def test_handles_missing_project_materials(self, mock_context_module, tmp_path):
    ...
    def test_handles_processor_exceptions_gracefully(self, pipeline_with_mocks, test_images, mock_context_module, caplog):
