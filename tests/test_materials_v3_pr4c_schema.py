...
def test_refinement_decision_requires_edge_signals():
    ...
    eligible, should_refine, reason = decide_refinement("glass", stats, edge_signals_weak, config, "canary")
    assert eligible is True
    ...
    eligible, should_refine, reason = decide_refinement("glass", stats, edge_signals_small, config, "canary")
    assert eligible is True
    assert should_refine is False
    ...
    eligible, should_refine, reason = decide_refinement("glass", stats, edge_signals_strong, config, "canary")
    assert eligible is True
