...
class TestCacheConfig:
    ...
    def test_custom_config(self):
        ...
        config = CacheConfig(cache_dir=cache_dir, max_size_gb=5.0, max_age_days=7.0, verbose=True)
...
class TestIncrementalCache:
    ...
    def temp_cache(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            config = CacheConfig(cache_dir=Path(tmpdir), max_size_gb=1.0, verbose=False)
    ...
    def test_get_or_compute_cache_hit(self, temp_cache):
        ...
        result1 = temp_cache.get_or_compute("test", compute_fn, inputs)
        ...
        result2 = temp_cache.get_or_compute("test", counting_compute, inputs)
    ...
    def test_get_or_compute_cache_miss(self, temp_cache):
        ...
        result = temp_cache.get_or_compute("test", compute_fn, inputs)
    ...
    def test_force_recompute(self, temp_cache):
        ...
        result1 = temp_cache.get_or_compute("test", lambda: {"value": 1}, inputs)
        assert result1 == {"value": 1}

        result2 = temp_cache.get_or_compute("test", lambda: {"value": 2}, inputs, force=True)
    ...
    def test_dependency_tracking(self, temp_cache):
        ...
        temp_cache.put("derived", {"x": 1}, {"result": 42}, dependencies={"base_key"})
