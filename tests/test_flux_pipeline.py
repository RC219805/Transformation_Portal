...
pytestmark = pytest.mark.skipif("torch" in sys.modules, reason="Tests require mocked torch environment")
...
class TestBuildControlNetPrompt:
    ...
    def test_build_controlnet_prompt_depth(self, mock_ml_modules):
        ...
        with mock_ml_environment():
            ...
            prompt = FLUXPipeline._build_controlnet_prompt(mock_self, "luxury kitchen", "depth", 0.7)
    ...
    def test_build_controlnet_prompt_canny(self, mock_ml_modules):
        ...
        with mock_ml_environment():
            ...
            prompt = FLUXPipeline._build_controlnet_prompt(mock_self, "modern bathroom", "canny", 0.7)
    ...
    def test_build_controlnet_prompt_normal(self, mock_ml_modules):
        ...
        with mock_ml_environment():
            ...
            prompt = FLUXPipeline._build_controlnet_prompt(mock_self, "luxury bedroom", "normal", 0.7)
    ...
    def test_build_controlnet_prompt_unknown_type(self, mock_ml_modules):
        ...
        with mock_ml_environment():
            ...
            prompt = FLUXPipeline._build_controlnet_prompt(mock_self, "test prompt", "unknown_type", 0.7)
