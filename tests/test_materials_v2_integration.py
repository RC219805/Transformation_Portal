...
class TestSegmentationDownscaling:
    ...
    def test_soft_mask_creation(self):
        ...
        config = SegmentationConfig(edge_feather_radius=3, edge_feather_sigma=1.0)
        ...
        assert 0.1 < soft_mask[30, 50] < 0.9  # Edge pixel
...
class TestErrorRecoveryFallbacks:
    ...
    def test_segmentation_fallback(self):
        ...
        error_msg = "ONNX segmentation failed"
    ...
    def test_memory_fallback(self):
        ...
        original_config = {"max_segmentation_side": 1536, "edge_feather_radius": 3}
