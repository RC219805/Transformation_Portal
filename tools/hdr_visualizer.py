...
class HDRVisualizer:
    ...
    def generate_histogram_comparison(
        self, before_path: Path, after_path: Path, scene_name: str, is_hdr: bool = False
    ) -> Path:
    ...
    def generate_luminance_distribution(self, before_path: Path, after_path: Path, scene_name: str) -> Path:
    ...
    def generate_clipping_analysis(self, image_path: Path, scene_name: str, is_before: bool = False) -> Path:
    ...
    def generate_dynamic_range_comparison(self, before_path: Path, after_path: Path, scene_name: str) -> Path:
