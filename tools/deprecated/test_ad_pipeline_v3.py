...
Run with:
    pytest tools/deprecated/test_ad_pipeline_v3.py -v
    pytest tools/deprecated/test_ad_pipeline_v3.py --cov=ad_editorial_post_pipeline_v3 --cov-report=html
...
pytestmark = pytest.mark.skipif(
    not RAWPY_AVAILABLE,
    reason="deprecated AD editorial v3 tests require rawpy",
)
