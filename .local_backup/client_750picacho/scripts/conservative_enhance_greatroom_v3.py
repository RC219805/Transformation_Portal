...
# Sky Correction (CRITICAL - addresses cyan cast) - OPTIMIZED
SKY_PERCENTILE = 99  # Top 1% brightest pixels (~120k pixels)
SKY_MASK_SIGMA = 10  # Increased for smoother transitions (was 7)
SKY_GREEN_REDUCTION = 0.80  # G: -20% (was 0.85/-15%) MORE AGGRESSIVE
SKY_BLUE_REDUCTION = 0.88   # B: -12% (was 0.92/-8%) MORE AGGRESSIVE
SKY_RED_BOOST = 1.12        # R: +12% (was 1.10/+10%) Warmer tone

# Global Adjustments (OPTIMIZED to protect whites while enriching interior)
GLOBAL_SATURATION = 1.08    # +8% (was 1.05) - sky handled separately
GLOBAL_CONTRAST = 1.05      # +5% (was 1.06) - gentler on whites
SHADOW_LIFT = 1.08          # +8% (was 1.10) - reduced to protect whites
EDGE_SHARPENING = 0.18      # 18% (was 0.20) - prevent white artifacts
