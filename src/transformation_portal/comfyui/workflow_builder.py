...
class WorkflowBuilder:
    ...
    def add_material_segmentation(
        self, materials: Optional[List[str]] = None
    ) -> "WorkflowBuilder":
    ...
    def add_neuroaesthetics_optimization(
        ...
        self._add_node(NodeType.NEUROAESTHETICS, parameters=params)
        self._last_output = "IMAGE"
    ...
    def add_atmospheric_model(
        ...
        self._add_node(NodeType.ATMOSPHERIC_MODEL, parameters=params)
        self._last_output = "IMAGE"
