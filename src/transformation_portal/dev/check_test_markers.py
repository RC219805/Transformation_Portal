...
This module provides reusable audit logic for marker enforcement.
The CLI wrapper is in scripts/validation/check_test_markers.py.
...
def main() -> int:
    """CLI entry point for marker enforcement."""
    args = _parse_args()
