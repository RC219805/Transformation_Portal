...
MAX_EV = 5.0                           # REDUCED from 6.5 to 5.0 (darker overall)

# Post-Tone-Map Adjustments (FURTHER REDUCED)
GLOBAL_EXPOSURE_LIFT = 0.20            # REDUCED from 0.28 to 0.20 (less brightness)
SHADOW_LIFT_STOPS = 0.10               # REDUCED from 0.18 to 0.10 (less shadow lift)
SHADOW_THRESHOLD = 0.30                # Protect more shadows
MIDTONE_CONTRAST = 1.03                # REDUCED from 1.04 to 1.03 (less contrast)
...
# Sky Protection (STRONGER - prevent clipping)
SKY_PROTECTION_THRESHOLD = 0.80        # Protect bright pixels
SKY_PROTECTION_STRENGTH = 0.90         # INCREASED from 0.6 to 0.90 (90% reduction)
SKY_MASK_SIGMA = 40.0                  # Very smooth transition

# Material Enhancement (FURTHER REDUCED)
CLARITY_STRENGTH = 0.02                # REDUCED from 0.03 to 0.02 (less clarity)
CLARITY_RADIUS = 128                   # Larger radius for subtlety
CLARITY_MASK_THRESHOLD = 0.90          # Exclude very bright areas
