#!/usr/bin/env python3
"""
Conservative Enhancement v5 - 750 Picacho Great Room
BALANCED: Aggressive sky correction + protected interior brightness
Based on v4 success but addressing overall brightness inflation

Key improvements over v4:
- Maintains excellent cyan sky removal (G-30%, B-22%, R+18%)
- CORRECTED: Reduced shadow lift to prevent brightness inflation
- ADDED: Global brightness normalization to preserve interior tones
...
print("=" * 80)
print("CONSERVATIVE ENHANCEMENT v5 - 750 PICACHO GREAT ROOM")
