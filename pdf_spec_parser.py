    ...
    def _get_fallback_specs(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'material_specifications': [
                FinishSpec(material='White Oak Flooring', material_type='wood',
                           finish_type='matte', location='living areas').to_dict(),
                FinishSpec(material='Carrara Marble', material_type='stone',
                           finish_type='honed', location='kitchen/bath').to_dict(),
                FinishSpec(material='Stainless Steel', material_type='metal',
                           finish_type='brushed', location='kitchen').to_dict(),
                FinishSpec(material='Floor-to-Ceiling Glass', material_type='glass',
                           finish_type='clear', location='living areas').to_dict(),
            ],
            'color_palette': [
