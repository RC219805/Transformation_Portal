...
def generate_fixture_images(output_dir: Path, width: int = 512, height: int = 512, seed: int = 42) -> Dict[str, dict]:
...
def save_ground_truth(ground_truth: Dict[str, dict], output_path: Path):
    ...
    data = {"root": "images", "images": ground_truth}
...
def main():
    ...
    ground_truth = generate_fixture_images(output_dir=args.output, width=args.width, height=args.height, seed=args.seed)
