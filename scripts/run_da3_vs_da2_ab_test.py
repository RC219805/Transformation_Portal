...
|--------|---------------|-------------------------|---|
| **Overall Lenient Pass** | {da3_lenient}/{total} ({da3_overall_pct:.1f}%) | {da2_lenient}/{total} ({da2_overall_pct:.1f}%) | {da3_overall_pct - da2_overall_pct:+.1f}% |
| **Texture Scenes** | {texture_da3_pass}/{len(texture_comps)} ({texture_da3_pct:.1f}%) | {texture_da2_pass}/{len(texture_comps)} ({texture_da2_pct:.1f}%) | {texture_da3_pct - texture_da2_pct:+.1f}% |
| **Structure Scenes** | {structure_da3_pass}/{len(structure_comps)} ({structure_da3_pct:.1f}%) | {structure_da2_pass}/{len(structure_comps)} ({structure_da2_pct:.1f}%) | {structure_da3_pct - structure_da2_pct:+.1f}% |
