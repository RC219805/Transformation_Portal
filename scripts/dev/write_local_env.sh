...
export TP_API_KEY="${KEY}"
export TP_BACKEND_API_KEY="${KEY}"
export TP_BACKEND_ORIGIN="http://127.0.0.1:8000"
export TP_FASTAPI_ORIGIN="http://127.0.0.1:8000"
export TP_FRONTDOOR_USERS_FILE="${USERS_FILE}"
export TP_FRONTDOOR_SESSION_DB="${SESSION_DB}"
export TP_FRONTDOOR_SESSION_SCALING_MODE="single_instance"
export TP_TRUSTED_HOSTS="localhost,127.0.0.1,::1,testserver"
