...
Usage:
    python scripts/run_aerial_enhancement.py
    python scripts/run_aerial_enhancement.py --input aerial.tiff --output enhanced.jpg
    python scripts/run_aerial_enhancement.py --batch input_dir/ --output-dir output/
    python scripts/run_aerial_enhancement.py --resolution 2048 --materials 6
...
# Try importing from multiple locations
try:
    ...
    try:
        ...
        try:
            ...
            print("   - /Users/rc/Transformation_Portal/board_material_aerial_enhancer.py")
            print("   - /Users/rc/Transformation_Portal/src/transformation_portal/enhancers/")
            print("\n   This script requires the MBAR material enhancer module.")
            sys.exit(1)
