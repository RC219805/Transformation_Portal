...
.PHONY: help test-fast test-novideo test-full test-integration test-structure test-utils test-orchestrator-contract test-orchestrator-http-contract test-portal-contract test-frontdoor-contract test-archive-gate-e2e seed-frontdoor-user run-frontdoor-local validate-orchestrator-http validate-portal-browser validate-frontdoor-browser validate-frontdoor-deployment-gate audit-pipeline-readiness coverage-fast-scope venv repair-core-venv setup clean \
...
help:
	...
	@echo "  test-archive-gate-e2e  Run archive gate E2E contract tests (Gates A, B, C)"
...
test-archive-gate-e2e:
	@echo "Running archive gate E2E contract tests (Gates A, B, C)..."
...
ci: lint check-json-serialization check-yaml-governance check-piptools-cache check-requirements-lock-contract check-ci-sync check-portal-asset-budgets test-fast test-orchestrator-contract test-frontdoor-contract
